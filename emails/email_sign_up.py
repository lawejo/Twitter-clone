...
def email_sign_up(receiver_email, user_verification_key):
    ...
    html = f"""<!DOCTYPE html
        ...
        ">
                                        <h2 style="font-size: 28px; font-weight: 900;">Activation</h2>
                                        <p style="font-weight: 100;">
                                            Hi there,
                                        </p>
                                        <p style="font-weight: 100;">We're excited to have you on board! You're just a few
                                            clicks away from getting
                                            started with Twitter. Copy the verification code
                                            below and follow the link to activate your account:</p>
                                            <p
                                style="border: 1px solid lightgrey; width: fit-content; padding: 8px; border-radius: 5px; background-color: lightgray; color: black;">
                                {user_verification_key}</p>
                                        <a href="https://lawejo.eu.pythonanywhere.com/verification" style="cursor: pointer; font: inherit; background-color: #1DA1F2; border: none; padding: 10px; text-transform: uppercase; letter-spacing: 2px; font-weight: 900; color: white; border-radius: 5px; box-shadow: 3px 3px #0074bc; text-decoration: none;">Activate Your Account</a>
